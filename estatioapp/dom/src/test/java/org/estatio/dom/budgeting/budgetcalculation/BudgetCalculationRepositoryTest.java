...
public class BudgetCalculationRepositoryTest {
    ...
    public static class FindByBudgetItemAllocationAndKeyItemAndCalculationType extends BudgetCalculationRepositoryTest {
        ...
        public void happyCase() {
            ...
            budgetCalculationRepository.findByBudgetItemAllocationAndKeyItemAndStatusAndCalculationType(budgetItemAllocation, keyItem, status, calculationType);
            ...
            assertThat(finderInteraction.getQueryName()).isEqualTo("findByBudgetItemAllocationAndKeyItemAndStatusAndCalculationType");
        ...
        public void updateOrCreateBudgetCalculation() {
            ...
            assertThat(
                    budgetCalculationRepository
                            .findByBudgetItemAllocationAndKeyItemAndStatusAndCalculationType(budgetItemAllocation, keyItem, null, null)
                            .getValue())
                    .isEqualTo(value);
            assertThat(
                    budgetCalculationRepository
